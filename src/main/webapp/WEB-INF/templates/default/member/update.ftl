...
<head>
    ...
    <title>用户修改 - ${SITE_NAME} - Powered By JEESNS</title>
    ...
    <div class="row login-panel">
        ...
        <div class="col-md-4">
            <div class="ibox-content">
                <h3>欢迎加入easytop</h3>
                <form class="m-t jeesns_form" action="${base}/member/updateUser" method="post">
                    <div class="form-group">
                    <div class="form-group">
                        <input style="visibility:hidden" type="text" name="id" value="${userId}">
                    </div>
                        用户名
